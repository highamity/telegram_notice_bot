...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = (
        ...
        "• !삭제 <키> — 공지 삭제\n\n"
        "【일정 알림】\n"
        "• !일정 <날짜/시간> <내용> (순서 앞뒤 상관없음)\n"
        "  예: !일정 9/20 14:00 팀 회의 (또는 !일정 팀 회의 9/20 14:00)\n"
        "  예: !일정 내일 10:00 치과 (또는 !일정 치과 내일 10:00)\n"
        "  예: !일정 9월20일 세미나 (시간 생략 시 오전 09:00)\n"
        "• !일정목록 (또는 !일정) — 예정된 일정 목록\n"
        "• !일정삭제 <ID> — 일정 삭제\n\n"
        "【디데이 & 기념일】\n"
        "• !디데이 <이름> <날짜> (순서 앞뒤 상관없음)\n"
        "  예: !디데이 수능 2026-11-19 (또는 !디데이 2026-11-19 수능) → [1회성 목표 🎯]\n"
        "  예: !디데이 결혼 2020-05-10 (또는 !디데이 2020-05-10 결혼) → [매년 반복 🔔]\n"
        ...
        "💡 팁: '내일 치과'처럼 날짜 단어가 포함된 이름은 따옴표(\"내일 치과\")나 붙여쓰기(내일치과)를 사용하면 더욱 안전합니다.\n\n"
        "【기타】\n"
        "• !도움말 (또는 /help) — 도움말 보기\n\n"
